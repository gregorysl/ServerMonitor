...
const oracle = [
  {
    ...
    CurrentBuildDate: "06/02/2018 09:49",
    DisplayName: "f-ora1",
    IsReserved: false,
    IsDeploying: false
  },
  {
    ...
    CurrentBuildDate: "08/02/2018 18:46",
    DisplayName: "f-ora2",
    IsReserved: false,
    IsDeploying: true
  },
  {
    ...
    CurrentBuildDate: "09/02/2018 00:50",
    DisplayName: "f-ora3",
    IsReserved: true,
    IsDeploying: false
  },
  {
    ...
    CurrentBuildDate: "09/02/2018 09:46",
    DisplayName: "f-ora4",
    IsReserved: false,
    IsDeploying: false
  }
  ...
  Object.keys(data.data).forEach(key => {
    Object.keys(data.data[key]).forEach(subkey => {
      if (subkey === "key" && data.data[key][subkey] === appName) {
        const state =
          data.data[key].state === "Started" ? "Stopped" : "Started";
